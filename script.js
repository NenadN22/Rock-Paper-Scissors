...
function playRound(humanChoice,computerChoice) { // Should be above the buttons loop
    ...
    // You can create a function that will handle the score and call it here
    ...
    // Try to combine the all score condinational together
    if (computerScore === 5 ) {
